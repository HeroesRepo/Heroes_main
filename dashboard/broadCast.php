...
$q="insert into bb_broadcast (bb_regno,broadcast) values('".$_SESSION['bb_regno']."','$broadcast')";
...
<div class="wrapper">
  ...
  <ul class="sidebar-menu">
        ...
        <li><a href="historicalStock.php"><i class="fa fa-table"></i> <span>Historical Stock</span></a></li>
          <li><a href="#"><i class="fa fa-globe"></i> <span>Broadcast</span></a></li>
              ...
              <div class="row">
                ...
                <div class="col-md-6"> 
                    <div class="panel panel-default">
                        ...
                        <form method="post">
                        <div class="panel-body"><center><textarea rows="5" cols="30" name="broadcast" wrap="hard" class="form-control"></textarea><br>
                        <input type="submit" class="btn btn-primary" name="Broadcast" value="Broadcast">
                        </center>
                        </div>
                        </form>
                    </div>
