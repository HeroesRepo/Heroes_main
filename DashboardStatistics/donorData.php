...
/*$( "#submit" ).click(function() {
   ...
   var dataString = 'bloodgroup1='+ bloodgroup;

        $.ajax({
        type: "POST",
        url: "assets/php/searchparticularDonor.php",
        data: dataString,
...
$(document).ready(function() {
    $('#FormId').submit(function(event) {
        ...
        $.ajax({
            ...
            url         : 'assets/php/searchparticularDonor.php', // the url where we want to POST
		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Donor Statistics</a>
                </div>
                    ...
                    <div class="col-md-8">
                       ...
                       <form id="FormId" method="post">
                                <div class="form-group">
                                                 ...
                                                 <div id="searchparticularDonor" ></div>
                            </div>
                                            </div>    
                                        </div>
                                    </div>
